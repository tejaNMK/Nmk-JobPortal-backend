...
class MasterNoticePeriod(SQLModel, table=True):
    __tablename__ = "master_notice_periods"
    __table_args__ = (Index("idx_master_notice_periods_label", "label", unique=True),)

    notice_period_id: str = Field(
